...
#SBATCH --job-name=mf_mair_p1
#SBATCH --time=01:00:00
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --gpus=h100:1
#SBATCH --output=logs/mf_mair_p1_%j.out
#SBATCH --error=logs/mf_mair_p1_%j.err
...
mkdir -p results/eval/methaneair_s2_p1
...
python scripts/eval/evaluate_classification_with_predictions.py \
  ...
  --num_workers 0 \
  --row_fusion_mode max \
  --output_json results/eval/methaneair_s2_p1/final16_with_predictions.json \
  --output_predictions_csv results/eval/methaneair_s2_p1/final16_predictions.csv
