...
AUDIT_OUTPUT = Path(
    "outputs/398_landsat_candidate_release_audit_v1.csv"
)

CLEAN_EXACT_OUTPUT = Path(
    "outputs/399_landsat_clean_exact_negative_candidates_v1.csv"
)

CLEAN_24H_OUTPUT = Path(
    "outputs/400_landsat_clean_24h_negative_candidates_v1.csv"
)

REPORT_OUTPUT = Path(
    "outputs/401_landsat_candidate_release_audit_report_v1.txt"
)
